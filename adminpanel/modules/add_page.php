...
<table width="650" bgcolor="#eeeeee" align="center" border="0" style="border: solid #cccccc 1px;">
	<tr>
		...
		<td><b>http://<?php print $_SERVER['SERVER_NAME']; ?>/</b><input class="inp" type="text" name="folder" size="30" maxlength="20" value="<?php print $folder; ?>" />/</td>
	</tr>
	<tr>
		<td><font color="red"><b>!</b></font>Заголовок:</td>
		<td><input class="inp" style="width: 500px;" type="text" name="title" size="80" maxlength="50" value="<?php print $title; ?>" /></td>
	</tr>
	<tr>
		<td>Ключевые слова:</td>
		<td><input class="inp" style="width: 500px;" type="text" name="keywords" size="80" maxlength="250" value="<?php print $keywords; ?>" /></td>
	</tr>
	<tr>
		<td>Описание&nbsp;страницы:</td>
		<td><input class="inp" style="width: 500px;" type="text" name="description" size="80" maxlength="250" value="<?php print $description; ?>" /></td>
	</tr>
	<tr>
		<td>Тип (модуль):</td>
		<td>
