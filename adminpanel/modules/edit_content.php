...
<table bgcolor="#eeeeee" width="612" align="center" border="0" style="border: solid #cccccc 1px; width: 612px;">
	<tr>
		...
		<td align="right"><input class="inp" style="width: 490px;" type="text" name="title" maxlength="50" value="<?php print $title; ?>" /></td>
	</tr>
	<?php
	if($type != 2) {
	?>
...
<script type="text/javascript">
	...
	<tr>
		...
		<td align="right"><input class="inp" style="width: 490px;" type="text" name="keywords" maxlength="250" value="<?php print $keywords; ?>" /></td>
	</tr>
		<tr>
		<td style="padding-left: 2px;">Описание&nbsp;страницы:</td>
		<td align="right"><input class="inp" style="width: 490px;" type="text" name="description" maxlength="250" value="<?php print $description; ?>" /></td>
	</tr>

	<tr><td colspan="2" align="center" height="30">Английская версия:</td></tr>

	<tr>
		<td style="padding-left: 2px;"><font color="red"><b>!</b></font>Заголовок:</td>
		<td align="right"><input class="inp" style="width: 490px;" type="text" name="title_en" maxlength="50" value="<?php print $title_en; ?>" /></td>
	</tr>
	<?php
	if($type != 2) {
	?>
	...
	<tr>
		<td style="padding-left: 2px;">Ключевые слова:</td>
		<td align="right"><input class="inp" style="width: 490px;" type="text" name="keywords_en" maxlength="250" value="<?php print $keywords_en; ?>" /></td>
	</tr>
		<tr>
		<td style="padding-left: 2px;">Описание&nbsp;страницы:</td>
		<td align="right"><input class="inp" style="width: 490px;" type="text" name="description_en" maxlength="250" value="<?php print $description_en; ?>" /></td>
	</tr>
</table>
