...
if ($_GET['go'] == "go") {
	...
	$subject_en		= htmlspecialchars($_POST['subject_en']);
...
<table bgcolor="#eeeeee" width="612" align="center" border="0" style="border: solid #cccccc 1px; width: 612px;">
	<tr>
		...
		<td align="right"><input class="inp" style="width: 490px;" type="text" name="subject" size="97" value="<?php print $subject; ?>"></td>
	</tr>
	<tr>
	...
	<tr>
		<td style="padding-left: 2px;">Тема&nbsp;новости:</td>
		<td align="right"><input class="inp" style="width: 490px;" type="text" name="subject_en" size="97" value="<?php print $subject_en; ?>"></td>
	</tr>
	<tr>
		<td align="center" style="padding-bottom: 10px;" colspan="2">
