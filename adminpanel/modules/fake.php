...
<tr bgcolor="#dddddd">
	...
	<td align="right"><input class="input" style="width: 280px;" type="text" name="fakeusers" size="70" maxlength="30" value="<?php print cfgSET('fakeusers'); ?>" /></td>
</tr>
<tr bgcolor="#eeeeee">
	<td><b>Добавить активных пользователей</b>:</td>
	<td align="right"><input class="input" style="width: 280px;" type="text" name="fakeactiveusers" size="70" maxlength="30" value="<?php print cfgSET('fakeactiveusers'); ?>" /></td>
</tr>
<tr bgcolor="#dddddd">
	<td><b>Добавить пользователей онлайн</b>:</td>
	<td align="right"><input class="input" style="width: 280px;" type="text" name="fakeonline" size="70" maxlength="30" value="<?php print cfgSET('fakeonline'); ?>" /></td>
</tr>
<tr bgcolor="#eeeeee">
	<td><b>Добавить к сумме депозитов</b>:</td>
	<td align="right"><input class="input" style="width: 280px;" type="text" name="fakedeposits" size="70" maxlength="30" value="<?php print cfgSET('fakedeposits'); ?>" /></td>
</tr>
<tr bgcolor="#dddddd">
	<td><b>Добавить/отнять сумму вывода</b> **:</td>
	<td align="right"><input class="input" style="width: 280px;" type="text" name="fakewithdraws" size="70" maxlength="30" value="<?php print cfgSET('fakewithdraws'); ?>" /></td>
</tr>
