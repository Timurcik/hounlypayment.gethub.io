...
-> Файл рассылки сообщений пользователям
*/
...
$msg		= $_POST['msg'];
	...
	$query	= "SELECT mail FROM users WHERE bot != 1";
...
<form action="?a=mailto&go=mailto" method="post" name="mainForm">
<table bgcolor="#eeeeee" width="612" align="center" border="0" style="border: solid #cccccc 1px; width: 612px;">
<tr><td align="center"><input class="inp" style="width: 605px;" size="97" name="subject" value="Рассылка проекта <?php print $cfgURL; ?>" type="text" maxlength="100"></td></tr>
