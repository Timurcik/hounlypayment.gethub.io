...
<table bgcolor="#eeeeee" width="612" align="center" border="0" style="border: solid #cccccc 1px; width: 612px;">
	<tr>
		...
		<td align="right"><input class="inp" style="width: 490px;" type="text" name="subject" size="97" /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td align="right"><input class="inp" style="width: 490px;" type="text" name="keywords" maxlength="250" /></td>
	</tr>
		<tr>
		<td style="padding-left: 2px;">Описание&nbsp;страницы:</td>
		<td align="right"><input class="inp" style="width: 490px;" type="text" name="description" maxlength="250" /></td>
	</tr>
	<tr>
	...
	<tr>
		<td style="padding-left: 2px;">Тема&nbsp;новости:</td>
		<td align="right"><input class="inp" style="width: 490px;" type="text" name="subject_en" size="97" /></td>
	</tr>
	<tr>
		<td align="center" style="padding-bottom: 10px;" colspan="2">
	...
	<tr>
		<td style="padding-left: 2px;">Ключевые слова:</td>
		<td align="right"><input class="inp" style="width: 490px;" type="text" name="keywords_en" maxlength="250" /></td>
	</tr>
		<tr>
		<td style="padding-left: 2px;">Описание&nbsp;страницы:</td>
		<td align="right"><input class="inp" style="width: 490px;" type="text" name="description_en" maxlength="250" /></td>
	</tr>
</table>
