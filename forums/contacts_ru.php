...
$action = htmlspecialchars(str_replace("'","",substr($_GET['action'],0,6)));
	...
	if($action == "submit") {
		...
		$subj		= htmlspecialchars(str_replace("'","",substr($_POST['subj'],0,100)));
		$textform	= htmlspecialchars(str_replace("'","",substr($_POST['textform'],0,10240)));
...
<center>
<img src="/images/email.png" width="300" height="281" border="0" alt="" />
		...
		<td>
			<table align="right" cellpadding="1" cellspacing="1" border="0">
				<tr>
					...
					<td><input class="subm" style="height: 25px;"  type="submit" value=" Отправить! " /></td>
				</tr>
			</table>
		</td>
	</tr>
