...
$sql = mysql_query("INSERT INTO `pages` VALUES (2, 'Авторизация', '', '', '', 'Login error', '', '', '', 'login', 2, 0, 1)");
...
$sql = mysql_query("INSERT INTO `pages` VALUES (5, 'Профиль', '', '', '', '', '', '', '', 'profile', 2, 0, 1)");
$sql = mysql_query("INSERT INTO `pages` VALUES (6, 'Пополнение баланса', '', '', '', '', '', '', '', 'enter', 2, 5, 1)");
$sql = mysql_query("INSERT INTO `pages` VALUES (7, 'Вывод средств', '', '', '', '', '', '', '', 'withdrawal', 2, 5, 1)");
$sql = mysql_query("INSERT INTO `pages` VALUES (8, 'Новости', '', '', '', '', '', '', '', 'news', 2, 0, 1)");
$sql = mysql_query("INSERT INTO `pages` VALUES (9, 'Контакты', '', '', '', '', '', '', '', 'contacts', 0, 0, 1)");
$sql = mysql_query("INSERT INTO `pages` VALUES (10, 'Правила проекта', '', '', '', '', '', '', '', 'law', 1, 0, 1)");
$sql = mysql_query("INSERT INTO `pages` VALUES (11, 'Помощь', '', '', '', '', '', '', '', 'help', 1, 0, 1)");
$sql = mysql_query("INSERT INTO `pages` VALUES (12, 'Партнерская программа', '', '', '', '', '', '', '', 'ref', 0, 5, 1)");
$sql = mysql_query("INSERT INTO `pages` VALUES (13, 'Депозиты', '', '', '', '', '', '', '', 'deposit', 2, 5, 1)");
$sql = mysql_query("INSERT INTO `pages` VALUES (14, 'Статистика', '', '', '', '', '', '', '', 'stat', 2, 5, 1)");
$sql = mysql_query("INSERT INTO `pages` VALUES (15, 'Ваши депозиты', '', '', '', '', '', '', '', 'deposits', 2, 5, 1)");
...
?>
	...
	<tr height="25">
		<td align="center">
<font color="#999999">&copy; 2007 - <?php print date(Y); ?> CMS <a style="font-weight: normal;" href="http://adminstation.ru/" target="_blank">AdminStation</a> v3.1.1 <a style="font-weight: normal;" href="http://adminstation.ru/images/docs/doc1.jpg" target="_blank">Все права защищены!</a><br />
Разработка компании информационных технологий Minatrix</font>
		</td>
	</tr>
</table>
</body>
