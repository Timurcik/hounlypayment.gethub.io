...
<div class="general-block-outer">
					<div class="general-block cart-container">
							<center><font color="#f2650a"><h2>Авторизации</h2></font></center>
							<br>					
						...
						<tr>
								...
								<td style="width:250px" class="product-name"><span class="heading">IP</span></td>
	...
	if(mysql_num_rows($rs)) {
		...
		while($a = mysql_fetch_array($rs)) {
				print "<tr>
								...
								<td style=\"width:550px\" class=\"product-name\">".$a['ip']."</td>
